            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-9 w-auto fill-current text-indigo-600 dark:text-indigo-400 drop-shadow-sm transition hover:scale-105" />
                    </a>
                </div>
            ...
            <div class="flex items-center sm:ms-6 gap-2">
                ...
                <div class="relative" x-data="{ openTheme: false }" @click.outside="openTheme = false">
                    <button @click="openTheme = !openTheme" title="Alterar tema" aria-label="Alterar tema" class="p-2 rounded-full text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none transition">
                        ...
                        <svg x-show="theme === 'dark'" style="display: none;" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div x-show="openTheme"
                        ...
                        class="absolute right-0 mt-2 w-32 rounded-md shadow-lg py-1 bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5 z-50">
                        <button @click="setTheme('light'); openTheme = false" class="flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600" :class="{ 'bg-gray-100 dark:bg-gray-600': theme === 'light' }">Claro</button>
                        <button @click="setTheme('dark'); openTheme = false" class="flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600" :class="{ 'bg-gray-100 dark:bg-gray-600': theme === 'dark' }">Escuro</button>
                        <button @click="setTheme('system'); openTheme = false" class="flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600" :class="{ 'bg-gray-100 dark:bg-gray-600': theme === 'system' }">Sistema</button>
                    </div>
                </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            ...
                            <div class="sm:hidden text-xs font-bold bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">Menu</div>
